...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    more: Attribute.DynamicZone<
      ['more-info.flower-detail', 'more-info.gorshok', 'more-info.rassada']
    >;
    Name: Attribute.String;
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    hasPassword: Attribute.Boolean & Attribute.DefaultTo<false>;
    otp: Attribute.String;
    otp_codes: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::otp-code.otp-code'
    >;
    otp_placeholder: Attribute.String;
    password: Attribute.Password &
      Attribute.Private &
      Attribute.SetMinMaxLength<{
        minLength: 6;
